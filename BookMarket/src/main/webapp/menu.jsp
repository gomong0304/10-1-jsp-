...
<header class="pb-3 mb-4 border-bottom">
	...
	<span class="fs-4">Home</span>
			...
			<ul class="nav nav-pills">
				...
				<li class="nav-item"><a href="./books.jsp" class="nav-link">도서목록</a>
				</li>

				<!-- p589 쪽 추가 -->
				<li class="nav-item"><a href="./addBook.jsp" class="nav-link">도서등록</a>
				</li>

				<!-- p590 쪽 추가 -->
				<li class="nav-item"><a href="./editBook.jsp?edit=update"
					class="nav-link">도서수정</a></li>

				<!-- p601 쪽 추가 -->
				<li class="nav-item"><a href="./editBook.jsp?edit=delete"
					class="nav-link">도서삭제</a></li>

				<li class="nav-item"><a href="./cart.jsp" class="nav-link">장바구니</a>
				</li>
			</ul>
		</div>
	</div>
